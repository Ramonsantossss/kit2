...
const img = 'https://telegra.ph/file/6685cb3b3e23afa3382fe.jpg'
const keynova = randomText(10);

    async function gerarUsuario(nome_usuario, senha, apikey, id, numero_zap) {
        let obj = { nome_usuario, senha, apikey, defaultKey: apikey, jid: id, numero_zap, status: null, perfil: img, premium: null, banido: null, motivo_ban: null, admin: true, resgatar: null, valoresgatar: null, musica: 'mscaqui', limit: limitOfc, dinheiro: 0, totalreq: 0, exp: 0, nivel: 1, bronze: 0, prata: 0, ouro: 0, diamante: 0 };
        usuario.create(obj);
    }
